...
public class TrackServiceTestJdk9Plus {
    /*
	...
	public void testDeleteTrack() {
		Track track1 = new Track("The Shadow Of Your Smile", List.of("Big John Patton"),
				"Let 'em Roll", "06:15", "1965");
		track1 = trackService.createTrack(track1);
		Track track2 = new Track("I'll Remember April", List.of("Jim Hall", "Ron Carter"),
